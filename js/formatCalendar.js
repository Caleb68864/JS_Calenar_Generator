function formatCalendar(cal_settings){
    ...
    if(parseInt(cal_settings["width"]) != 0){
        ...
        $('.weekdays td').css('width', parseInt(dayWidth) + "in");
        $('.calendar').css('width', parseInt(cal_settings["width"]) + "in");
    }
    if(parseInt(cal_settings["height"]) != 0){
        ...
        $('.calendar').css('height', parseInt(cal_settings["height"]) + "in");
    }
    if(cal_settings['num_align_h'] != null){
        $('.weekday td').css('text-align', cal_settings['num_align_h']);
    }
    if(cal_settings['num_align_v'] != null){
        $('.weekday td').css('vertical-align', cal_settings['num_align_v']);
    }
